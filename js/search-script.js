...
function() {
    ...
    var i = {
        compile: function(r) {
            return o.template.replace(o.pattern,
            function(t, e) {
    ...
    var u = {
        put: function(t) {
            ...
            if (function(t) {
                ...
                l();
                for (var n = 0,
                r = t.length; n < r; n++) f(t[n]) && e.push(p(t[n]));
                return e
            } (t);
            return undefined
        },
                ...
                for (var i = [], o = 0; o < t.length && i.length < r.limit; o++) {
                    var u = function(t, e, n, r) {
                        ...
                        function(t, e) {
                            ...
                            r = 0,
                            i = (e = e || []).length; r < i; r++) {
                                var o = e[r]; ! n && new RegExp(t).test(o) && (n = !0)
                            }
                            return n
        ...
        setOptions: function(t) { (c = t || {}).fuzzy = t.fuzzy || !1,
            c.limit = t.limit || 10,
    ...
    function y(t) {
        u.put(t),
        m.searchInput.addEventListener("input",
        function(t) { - 1 === [13, 16, 20, 37, 38, 39, 40, 91].indexOf(t.which) && (g(), z(t.target.value))
        })
    }
    function g() {
    ...
    function z(t) {
        var e; (e = t) && 0 < e.length && (g(),
        function(t, e) {
            var n = t.length;
            if (0 === n) return O(m.noResultsText);
            for (var r = 0; r < n; r++) t[r].query = e,
            O(i.compile(t[r]))
        } (u.search(t), t))
    }
    function S(t) {
    ...
    t.SimpleJekyllSearch = function(t) {
        ...
        h.isJSON(m.json) ? y(m.json) : (n = m.json, d.load(n,
        function(t, e) {
        ...
        return "function" == typeof m.success && m.success.call(e),
        e
    }
} ();
