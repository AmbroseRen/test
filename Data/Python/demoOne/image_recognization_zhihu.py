...
import lib.TencentYoutuyun
#from lib.TencentYoutuyun.auth import *
#from lib.TencentYoutuyun.youtu import *
...
def recognition_captcha(data):
    ...
    userid= 'userid'
    end_point = lib.TencentYoutuyun.conf.API_YOUTU_END_POINT

    youtu = lib.TencentYoutuyun.YouTu(appid, secret_id, secret_key, userid, end_point) # 初始化
    ...
    result = lib.TencentYoutuyun.youtu.generalocr( filename_png , data_type = 0 , seq = '')  #  0代表本地路径，1代表url
